...
class CategorySeeder extends Seeder
{
    ...
    public function run(): void
    {
        $categoriesList = [
            ...
            ['cat_name_ar' => 'قطع غيار جديدة', 'cat_name_en' => 'New Spare Parts', 'cat_icon_path' => 'spare-parts-new-icon.png', 'commission_type' => CommissionTypeEnum::Rate->value, 'commission' => 0.01],
